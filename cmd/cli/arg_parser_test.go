...
func TestParseArgs(t *testing.T) {
	tests := []struct {
		...
		// Valid combinations
		{
			...
			args:   []string{"tabula", "-s", "scriptFile"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-i", "csvFile"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-o", "output.csv", "-i", "csvFile"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-u", "csvFile"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-i", "csvFile", "-a"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-i", "csvFile", "-o", "output.csv", "-a"},
		...
		},
		{
			...
			args:   []string{"tabula", "-s", "scriptFile", "-u", "csvFile", "-a"},
		...
		},
		{
			...
			args:   []string{"tabula", "-e", "sum(amount)", "-i", "csvFile"},
		...
		},
		{
			...
			args:   []string{"tabula", "-e", "sum(amount)", "-i", "csvFile", "-o", "output.csv"},
