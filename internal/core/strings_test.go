...
func TestCONCATENATE(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `CONCATENATE(values:string...):string received invalid argument <int 42> in (CONCATENATE <str "hello"> <int 42>), at <: input:0:0>`,
		},
	}
...
func TestLEN(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `LEN(value:string):number expects 1 argument, got 2 in (LEN <str "hello"> <str "world">), at <: input:0:0>`,
		},
		{
			Name: "integer input",
			Input: []ast.Expression{
			...
			Error: "LEN(value:string):number received invalid argument <int 123> in (LEN <int 123>), at <: input:0:0>",
		},
	}
...
func TestLOWER(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `LOWER(value:string):string expects 1 argument, got 2 in (LOWER <str "Hello"> <str "World">), at <: input:0:0>`,
		},
	}
...
func TestUPPER(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `UPPER(value:string):string expects 1 argument, got 2 in (UPPER <str "hello"> <str "world">), at <: input:0:0>`,
		},
	}
...
func TestTRIM(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `TRIM(value:string):string expects 1 argument, got 2 in (TRIM <str "  hello  "> <str "  world  ">), at <: input:0:0>`,
		},
	}
...
func TestEXACT(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: "EXACT(a:string, b:string):boolean expects 2 arguments, got 1 in (EXACT <str \"hello\">), at <: input:0:0>",
		},
		{
		...
		},
		{
			...
			Error: "EXACT(a:string, b:string):boolean expects 2 arguments, got 3 in (EXACT <str \"hello\"> <str \"world\"> <str \"extra\">), at <: input:0:0>",
		},
	}
...
func TestFIND(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `FIND(what:string, where:string, [start:int]):number received invalid argument <str "not_int"> in (FIND <str "hello"> <str "world"> <str "not_int">), at <: input:0:0>`,
		},
	}
...
func TestLEFT(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `LEFT(value:string, [amount:int]):string expects 2 arguments, got 3 in (LEFT <str "hello"> <int 3> <str "extra">), at <: input:0:0>`,
		},
	}
...
func TestRIGHT(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `RIGHT(value:string, [amount:int]):string expects 2 arguments, got 3 in (RIGHT <str "hello"> <int 3> <str "extra">), at <: input:0:0>`,
		},
	}
...
func TestMID(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `MID(value:string, start:int, amount:int):string expects 3 arguments, got 2 in (MID <str "hello"> <int 2>), at <: input:0:0>`,
		},
		{
			Name: "too many arguments",
			Input: []ast.Expression{
			...
			Error: `MID(value:string, start:int, amount:int):string expects 3 arguments, got 4 in (MID <str "hello"> <int 2> <int 3> <str "extra">), at <: input:0:0>`,
		},
	}
...
func TestSUBSTITUTE(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: `SUBSTITUTE(text:string, old:string, new:string, [instances:int]):string received invalid argument <int -1> in (SUBSTITUTE <str "hello world world"> <str "world"> <str "universe"> <int -1>), at <: input:0:0>`,
		},
		{
			Name: "too few arguments",
			Input: []ast.Expression{
			...
			Error: `SUBSTITUTE(text:string, old:string, new:string, [instances:int]):string expects 4 arguments, got 2 in (SUBSTITUTE <str "hello"> <str "world">), at <: input:0:0>`,
		},
	}
...
func TestVALUE(t *testing.T) {
	testcases := []InfoTestCase{
		...
		},
		{
			...
			Error: "VALUE(value:string):number expects 1 argument, got 2 in (VALUE <str \"7\"> <str \"42\">), at <: input:0:0>",
		},
		{
			...
			Error: "VALUE(value:string):number received invalid argument <int 42> in (VALUE <int 42>), at <: input:0:0>",
		},
	}
