...
const mockValidateCSVSettings = validateCSVSettings as jest.MockedFunction<typeof validateCSVSettings>;
const mockShowWarningNotice = showWarningNotice as jest.MockedFunction<typeof showWarningNotice>;
...
describe('Main Plugin Integration', () => {
  ...
  describe('Plugin lifecycle', () => {
    it('should load successfully with valid settings', async () => {
      ...
      expect(plugin.registerExtensions).toHaveBeenCalledWith(['csv'], 'csv-view');
  ...
  describe('View factories', () => {
    ...
    it('should create table view with settings', () => {
      ...
      const registerViewCall = (plugin.registerView as jest.Mock).mock.calls
        .find(call => call[0] === 'csv-view');
    ...
    it('should create source view', () => {
      const mockLeaf = { view: null } as any;
      const registerViewCall = (plugin.registerView as jest.Mock).mock.calls
        .find(call => call[0] === 'csv-source-view');
  ...
  describe('Error handling', () => {
    it('should not crash on view factory errors', async () => {
      ...
      const tableViewFactory = (plugin.registerView as jest.Mock).mock.calls
        .find(call => call[0] === 'csv-view')[1];
