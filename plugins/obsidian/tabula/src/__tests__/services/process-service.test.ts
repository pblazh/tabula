import {
  executeTabula,
  checkTabulaExecutableAvailable,
...
describe("Process Service", () => {
  ...
  describe("executeTabula", () => {
    ...
    it("should validate executable name", async () => {
      const result = await executeTabula(
        "rm -rf /",
        "/test/path/file.csv",
        false,
      );
  ...
  describe("checkTabulaAvailable", () => {
    it("should return true when tabula is available", async () => {
      ...
      const result = await checkTabulaExecutableAvailable("tabula");
    ...
    it("should return false for invalid executable name", async () => {
      const result = await checkTabulaExecutableAvailable("invalid; command");
    ...
    it("should handle timeout properly", async () => {
      ...
      await checkTabulaExecutableAvailable("tabula");
