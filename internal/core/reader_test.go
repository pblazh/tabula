...
func TestReadValue(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			format:   "%d",
			expected: nil,
			error:    "cannot parse \"not a number\" with format \"%d\"",
		},
		{
			...
			format:   "%t",
			expected: nil,
			error:    "cannot parse \"\" with format \"%t\"",
		},
		{
			...
			format:   "%v",
			expected: nil,
			error:    "cannot parse date: hello with format %v",
		},
		{
			...
			expected: nil,
			error:    "cannot parse date: big with format no placeholder here",
		},
		{
			...
			format:   "%s %s",
			expected: nil,
			error:    "cannot parse \"world\" with format \"%s %s\"",
		},
		{
