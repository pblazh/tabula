...
func TestMakeExactTypesGuard(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedError: "unsupported function call (TEST <str \"hello\">)",
		},
		{
			...
			expectedError: "unsupported function call (TEST <bool true>)",
		},
		{
		...
		},
		{
			...
			expectedError: "unsupported function call (TEST <int 1> <str \"hello\">)",
		},
		{
		...
		},
		{
			...
			expectedError: "unsupported function call (TEST <str \"hello\"> <int 1>)",
		},
		{
		...
		},
		{
			...
			expectedError: "unsupported function call (TEST <int 1>)",
		},
	}
