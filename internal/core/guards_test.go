...
func TestMakeArityGuard(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectsError: `TEST() expects 0 arguments, got 1 at input:0:0`,
		},
		{
		...
		},
		{
			...
			arity:        1,
			values:       []ast.Node{},
			expectsError: `TEST() expects 1 argument, got 0 at input:0:0`,
		},
		{
			...
			expectsError: `TEST() expects 1 argument, got 2 at input:0:0`,
		},
		{
		...
		},
		{
			...
			expectsError: `TEST() expects 2 arguments, got 1 at input:0:0`,
		},
		{
...
func TestMakeExactTypesGuard(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectsError: `TEST() invalid argument "hello" at input:0:0`,
		},
		{
			...
			expectsError: `TEST() invalid argument true at input:0:0`,
		},
		{
		...
		},
		{
			...
			expectsError: `TEST() invalid argument 1 at input:0:0`,
		},
	}
